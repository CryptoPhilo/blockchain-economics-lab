  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <div className="space-y-4 mb-8">
        <form action={`/${locale}/alerts`} method="GET" className="flex gap-3">
        ...
        {searchQuery && (
          <div className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <Link href={`/${locale}/alerts`} className="text-red-400 hover:text-red-300 ml-2">
              {locale === 'ko' ? '초기화' : 'Clear'}
            </Link>
      ...
      {reports && reports.length > 0 ? (
        ...
        <div className="text-center py-20 rounded-2xl bg-white/[0.03] border border-white/5">
          ...
          {searchQuery && (
            <Link href={`/${locale}/alerts`} className="text-red-400 hover:text-red-300 mt-4 inline-block">
