...
describe('score page CMC canonical Top 500 snapshot guard', () => {
  ...
  it('maps Gram rebrand rows to the Toncoin report-bearing project', () => {
    const trackedProjects = [
      {
        id: 'gram-market-project',
        name: 'Gram',
        slug: 'gram',
        symbol: 'GRAM',
        category: 'Layer 1',
  ...
  it('separates Falcon USD from Falcon Finance FF CMC aliases', () => {
    const trackedProjects = [
      {
        ...
        aliases: [],
        maturity_score: 38,
        last_econ_report_at: '2026-06-12T00:00:00.000Z',
        last_maturity_report_at: '2026-06-12T00:00:00.000Z',
        last_forensic_report_at: null,
      },
      {
        id: 'falcon-finance-project',
        name: 'Falcon Finance',
        ...
        aliases: [],
        maturity_score: 70,
        last_econ_report_at: '2026-06-11T00:00:00.000Z',
        last_maturity_report_at: '2026-06-11T00:00:00.000Z',
        last_forensic_report_at: null,
      },
    ]
    const snapshotRows = Array.from(
      { length: 500 },
      (_, index) => {
        if (index === 132) return makeSnapshotRow(index + 1, 'falcon-finance-ff')
        if (index === 204) return makeSnapshotRow(index + 1, 'falcon-finance')
...
describe('score page tracked project aliases', () => {
  ...
  it('maps Avalanche market rows to the canonical avalanche-2 project', () => {
    const trackedProjects = [
      {
        id: 'avalanche-market-shell',
        name: 'Avalanche',
        slug: 'avalanche',
        symbol: 'AVAX',
      ...
      },
      {
        ...
        maturity_score: 72,
        last_econ_report_at: '2026-05-14T00:00:00.000Z',
        last_maturity_report_at: '2026-06-17T00:00:00.000Z',
        last_forensic_report_at: null,
      },
    ]
...
describe('score page report availability policy', () => {
  ...
  it('uses slug-level report availability when duplicate project rows split ranking and report ids', () => {
    const trackedProjects = [
      {
