-- Create the missing AWE Korean forensic report shell required by the
...
SELECT
  ...
  jsonb_build_object(
    ...
    'summary_authority_target', jsonb_build_object(
      'issue', 'BCE-2159',
      'job_id', 'de5600d2-6b4d-4691-82cd-4d69a08b2a62',
      'source_identity', 'drive:1ApDo2bVWFAykInB4mdh0rzQKMtzULmJ9:0B8HYgThT3NByQm0xcUlySGE4RzFpM1J1V2Q2NWlHSTRyOWs4PQ',
      'drive_file_id', '1ApDo2bVWFAykInB4mdh0rzQKMtzULmJ9',
      'revision_id', '0B8HYgThT3NByQm0xcUlySGE4RzFpM1J1V2Q2NWlHSTRyOWs4PQ',
      'created_for', 'Summary Authority Gate target backfill'
    )
  ),
  true,
  'summary-authority-target:awe-network/forensic/ko/version:1',
...
WHERE target_project.slug = 'awe-network'
